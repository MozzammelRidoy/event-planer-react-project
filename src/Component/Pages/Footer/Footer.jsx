  ...
  return (
    <div>
      <footer className="p-3 md:p-10 bg-base-200 text-base-content">
        ...
        <aside>
          <p className="text-xl  md:text-3xl font-Pacifico">
            Event Planer
          </p>
          <p>
            ACME Industries Ltd.
        ...
        <nav>
          ...
          <a className="link link-hover">Decoration</a>
          <a className="link link-hover">Event Planning</a>
          <a className="link link-hover">Venue Management</a>
        </nav>
        <nav>
      ...
      <footer className="md:px-10 p-3  md:py-4 border-t bg-base-200 text-base-content border-base-300">
        <div className="footer md:max-w-6xl flex items-center justify-between mx-auto">
          <aside className="items-center grid-flow-col">
                <img className="w-12 h-12 rounded-full" src="https://i.ibb.co/nwnScB7/2212image-1700032725-524-12.png" alt="" />
            <p>
              Develop By | <br />
              Mozzammel Ridoy
            </p>
